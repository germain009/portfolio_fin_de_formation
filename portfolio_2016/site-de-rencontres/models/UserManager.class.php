...
class UserManager
{
        ...
        public function getAllConnecte()
	{
        ...
        public function getAllConnecte_rech()
	{
            $list = [];
	    $query = "SELECT * FROM users
                      WHERE connecte = 1 
        ...
        public function getMembres()
	{
        ...
        public function getMembres_choisis($sexe,$age_min,$age_max,$region,$connecte)
	    {
            $list = [];
            if($region == '...')
            {
         ...
         public function getMembres_choisis_pagination($sexe,$age_min,$age_max,$region,$connecte,$p_page,    $par_pages)
	     {
            $list = [];
            if($region == '...')
            {
        ...
        public function updatePassword(User $user)
	{
        ...
        //pour selectionner les membres connectées ou deconnectés en fonction de connecte 
